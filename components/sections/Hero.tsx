  ...
  return (
    <section className="relative isolate overflow-hidden lg:pb-[75px]">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-20">
        ...
        {/* Радиального пятна вокруг прибора здесь больше нет: вместе
            с осветлением в самом кадре оно давало видимый овал —
            «свечение». Тень к краям теперь одна и запечена в кадр
            виньеткой, см. `scripts/prepare-hero.mjs`. */}
      </div>
