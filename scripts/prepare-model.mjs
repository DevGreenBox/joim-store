 ...
 * три Float32 — половины габарита по осям), дальше по вершине четыре Int16:
 * x, y, z и номер детали. Половины габарита нужны шейдеру, чтобы положить
 * заводские виды «лицевая» и «задняя» ровно на грани корпуса. Координаты
